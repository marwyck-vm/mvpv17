                    ...
                    <div className="max-w-2xl">
                      <div className="space-y-6">
                        {selectedFile?.contacts?.map((contact, index) => (
                          <div key={contact.id} className={`bg-white rounded-[9px] border border-gray-200 p-6 ${index > 0 ? 'mt-4' : ''}`}>
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="space-y-4">
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => setTempContactData(prev => ({ ...prev, name: e.target.value }))}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-[9px] focus:outline-none focus:border-black"
                                  />
                                </div>
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => setTempContactData(prev => ({ ...prev, email: e.target.value }))}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-[9px] focus:outline-none focus:border-black"
                                  />
                                </div>
                                <div>
                        ...
                        <button
                          ...
                          className="w-full mt-4 py-3 border-2 border-dashed border-gray-300 rounded-[9px] text-gray-500 hover:border-gray-400 hover:text-gray-700 transition-colors flex items-center justify-center space-x-2"
                        >
